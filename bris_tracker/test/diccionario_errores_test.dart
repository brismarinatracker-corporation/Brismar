...
void main() {
  group('DiccionarioErrores Tests', () {
    test('Debe devolver el mensaje por defecto para errores desconocidos', () {
      ...
      expect(
        error.mensaje,
        equals('Ocurrió un error inesperado en el sistema.'),
      );
    });
    ...
    test(
      'Debe mapear AuthException de Supabase a error de Autenticación genérico',
      () {
        final authEx = const AuthException(
    ...
    test('Debe mapear PostgrestException a error de Base de Datos', () {
      final dbEx = const PostgrestException(

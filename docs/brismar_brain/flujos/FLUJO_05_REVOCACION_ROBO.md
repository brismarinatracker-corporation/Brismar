...
### 2. Autodestrucción Local de Datos (Device Wipe)
...
2.  **Destrucción de Claves de Cifrado:** Llama al `secureStorage.deleteAll()` ([gestor_almacenamiento_seguro.dart](file:///c:/BRISMAR_APP/brismar_app/lib/nucleo/seguridad/gestor_almacenamiento_seguro.dart)), borrando:
...
La lógica del auto-bloqueo se gestiona en la capa del gestor de almacenamiento seguro y el interceptor de peticiones del cliente HTTP:
...
*   Gestores de seguridad locales: [gestor_almacenamiento_seguro.dart](file:///c:/BRISMAR_APP/brismar_app/lib/nucleo/seguridad/gestor_almacenamiento_seguro.dart) y [servicio_cifrado.dart](file:///c:/BRISMAR_APP/brismar_app/lib/nucleo/seguridad/servicio_cifrado.dart).

...
class DialogoCompra {
  static void mostrar(
    ...
    final embarcacionCtrl = TextEditingController(
      text: compra?.embarcacion ?? '',
    );
    String productoSeleccionado = compra?.producto ?? 'POTA';
    final kilosCtrl = TextEditingController(
      text: compra?.kilos.toString() ?? '',
    );
    final precioCtrl = TextEditingController(
      text: compra?.precioUnitario.toString() ?? '',
    );
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: _decoracionDialogo(
                        'Ej. DON LUCHO II',
                        icono: Icons.directions_boat_outlined,
                      ),
                    ),

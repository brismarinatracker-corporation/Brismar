  ...
  InputDecoration _decoracion(
    ...
    return InputDecoration(
      ...
      suffixIcon: esSoloLectura
          ? const Tooltip(
              message:
                  'Este campo proviene de la App móvil y no puede ser modificado aquí.',
              child: Icon(
                Icons.lock_outline,
                color: Color(0xFF94A3B8),
                size: 18,
      ...
      enabledBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
          color: esSoloLectura ? const Color(0xFFE2E8F0) : Colors.transparent,
        ),
      ),

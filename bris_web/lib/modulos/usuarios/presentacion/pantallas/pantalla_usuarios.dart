...
///
/// No contiene `Scaffold` propio ya que vive dentro del [LayoutDashboard]
/// que actúa como Shell del enrutador y provee el Scaffold raíz.
          ...
          Expanded(
            child: Padding(
              ...
              child: estado.cargando && estado.usuarios.isEmpty
                  ? const ShimmerTablaCarga(oscuro: false, filas: 5)
                  : Container(
                          ...
                          Expanded(
                            child: estado.error != null && estado.usuarios.isEmpty
                                ...
                                : (() {
                                    ...
                                    final endIndex = (startIndex + _elementosPorPagina > estado.usuarios.length)
                                        ? estado.usuarios.length
                                        : startIndex + _elementosPorPagina;
                                    
                                    final usuariosPaginados = estado.usuarios.sublist(startIndex, endIndex);
                                    final totalPaginas = (estado.usuarios.length / _elementosPorPagina).ceil();

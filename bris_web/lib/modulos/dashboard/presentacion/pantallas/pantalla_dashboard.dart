          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                OutlinedButton.icon(
                  onPressed: estado.cargando ? null : () => ref.read(controladorDashboardProvider.notifier).cargarKpis(),
                  icon: estado.cargando ? const CargaOrbital(tamano: 16) : const Icon(Icons.refresh_rounded, size: 18),

...
* **Gestión de Ramas y Releases:**
  * `main`: Rama de producción. Solo contiene código estable y versiones tageadas (`vX.Y.Z`). **Prohibido realizar commits directos.** Cada versión en `main` debe tener su respectivo Release formal creado en GitHub.
